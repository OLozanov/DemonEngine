...
const TypeInfo Trigger::TriggerTypeInfo = { "Trigger",
                                             ...
                                             {{"pos", TypeInfoMember::Type::Vec3, 0, offsetof(Trigger, m_pos), 0},
                                              ...
                                              {"vehicle", TypeInfoMember::Type::Bool, 0, offsetof(Trigger, m_vehicle), 0},
...
Trigger::Trigger(const vec3& pos, const vec3& size, bool vehicle, const std::string& id)
...
void Trigger::write(FILE* file) const
{
    ...
    fwrite(&m_vehicle, sizeof(bool), 1, file);
